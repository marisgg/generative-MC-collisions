...
class VAE(nn.Module):
    ...
    def loss_function(self, input):
        ...
        # Use half of the KL loss s.t. reconstruction loss is more important.
...
class GAN(nn.Module):
    def __init__(self, input_shape, latent_dim = 100, lr=1e-3):
        ...
        self.optimizer_G = torch.optim.Adam(self.generator.parameters(), lr=lr) # betas=(opt.b1, opt.b2))
        self.optimizer_D = torch.optim.Adam(self.discriminator.parameters(), lr=lr) #, betas=(opt.b1, opt.b2))
